document.addEventListener('DOMContentLoaded', function () {
    ...
    // Remove old contact form validation and submission handler
...
document.getElementById("form").addEventListener("submit", function (e) {
    ...
    fetch(
        "https://script.google.com/macros/s/AKfycbx_25hrbb2_AS9Ic9cJdVkpGO2YTyMohN26prc8oqbCQ5AZctSnKy8tY7scCOaOHFGqIg/exec",
        {
            redirect: "follow",
            method: "POST",
            body: formDataString,
